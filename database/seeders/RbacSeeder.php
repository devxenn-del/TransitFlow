...
class RbacSeeder extends Seeder
{
    ...
    private array $catalogue = [
        ...
        'Conductors' => [
            ['conductors.view', 'View Conductors', 'Conductors', '/company/conductors', 'bi-person-vcard'],
            ['conductors.create', 'Add Conductor', null, null, null],
            ['conductors.edit', 'Edit Conductor (incl. assigned buses)', null, null, null],
            ['conductors.delete', 'Delete Conductor', null, null, null],
        ],
        'Passenger Types' => [
    ...
    private array $roleGrants = [
        ...
        'company_admin' => [
            ...
            'conductors.view', 'conductors.create', 'conductors.edit', 'conductors.delete',
        ...
        'manager' => [
            ...
            'terminals.view', 'buses.view', 'routes.view', 'drivers.view', 'conductors.view', 'passengertypes.view',
        ...
        'office' => [
            'dashboard.view',
            'reports.view', 'dailyops.view', 'expensereport.view', 'cashcountreport.view', 'fuelenergyreport.view',
            'accounts.view', 'terminals.view', 'buses.view', 'routes.view', 'drivers.view', 'conductors.view',
            'thermalprinters.view', 'adminassignments.view',
